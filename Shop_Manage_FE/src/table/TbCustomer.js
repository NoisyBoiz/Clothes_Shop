...
import "../css/TbCustomer.css"

function Customer({data,select,handleSelect, handleDeleteData}){
    ...
    return(
        <div className="customer-container">
            <div className="customer-table">  
                <ul className="header-list-customer"> 
                    <h1> Customer </h1>
                    <li> Select </li>
                    <li> Id </li>
                    <li> Username </li>
                ...
                {data.map((item,index)=>{
                    return(
                        <ul key={index} className={`list-customer-rows ${select.includes(item.id)?"selectActive":""} `}> 
                            <li> 
                            ...
                            <li> <Link to={"/edit/customers/"+item.id} > <BiEditAlt/> </Link></li>
                            <li onClick={()=>{
                                notification.comfirm({
                                    title:"Delete Customer",
                                    message:"Are you sure you want to delete this Customer?",
                                    handleAccept:()=>{
                                        handleDeleteData("Customers",item.id)
                                    },
